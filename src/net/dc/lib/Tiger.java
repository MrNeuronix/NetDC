...
public final class Tiger extends MessageDigest {
    ...
    public Tiger() {
	this(DEFAULT_BLOCKSIZE, HASH_SIZE);
	engineReset();
    }

    protected Tiger(int blockSize, int hashSize) {
	super("Tiger");
	...
	if (bufOff == blockSize) {
	    for (int i = 0; i < 8; i++)
		tmp[i] = ((buf[offset++] & (long) 0xFF))
			| ((buf[offset++] & (long) 0xFF) << 8)
			| ((buf[offset++] & (long) 0xFF) << 16)
			| ((buf[offset++] & (long) 0xFF) << 24)
			| ((buf[offset++] & (long) 0xFF) << 32)
			| ((buf[offset++] & (long) 0xFF) << 40)
			| ((buf[offset++] & (long) 0xFF) << 48)
			| ((buf[offset++] & (long) 0xFF) << 56);
	...
	while (length >= (todo = blockSize - this.bufOff)) {
	    ...
	    int offsets = 0;
	    for (int i = 0; i < 8; i++)
		tmp[i] = ((buf[offsets++] & (long) 0xFF))
			| ((buf[offsets++] & (long) 0xFF) << 8)
			| ((buf[offsets++] & (long) 0xFF) << 16)
			| ((buf[offsets++] & (long) 0xFF) << 24)
			| ((buf[offsets++] & (long) 0xFF) << 32)
			| ((buf[offsets++] & (long) 0xFF) << 40)
			| ((buf[offsets++] & (long) 0xFF) << 48)
			| ((buf[offsets++] & (long) 0xFF) << 56);
	...
	this.buf[this.bufOff++] = (byte) 0x01;
	...
	if (this.bufOff > C) {
	    ...
	    int offsets = 0;
	    for (int i = 0; i < 8; i++)
		tmp[i] = ((this.buf[offsets++] & (long) 0xFF))
			| ((this.buf[offsets++] & (long) 0xFF) << 8)
			| ((this.buf[offsets++] & (long) 0xFF) << 16)
			| ((this.buf[offsets++] & (long) 0xFF) << 24)
			| ((this.buf[offsets++] & (long) 0xFF) << 32)
			| ((this.buf[offsets++] & (long) 0xFF) << 40)
			| ((this.buf[offsets++] & (long) 0xFF) << 48)
			| ((this.buf[offsets++] & (long) 0xFF) << 56);
	...
	buf[offset++] = (byte) (b);
	buf[offset++] = (byte) (b >> 8);
	buf[offset++] = (byte) (b >> 16);
	buf[offset++] = (byte) (b >> 24);
	buf[offset++] = (byte) (b >> 32);
	buf[offset++] = (byte) (b >> 40);
	buf[offset++] = (byte) (b >> 48);
	buf[offset++] = (byte) (b >> 56);

	buf[offset++] = (byte) (c);
	buf[offset++] = (byte) (c >> 8);
	buf[offset++] = (byte) (c >> 16);
	buf[offset++] = (byte) (c >> 24);
	buf[offset++] = (byte) (c >> 32);
	buf[offset++] = (byte) (c >> 40);
	buf[offset++] = (byte) (c >> 48);
	buf[offset] = (byte) (c >> 56);
	engineReset();
	return hashSize;
    }
